...
def generate_data_description(save_dir):
    ...
    dataset['root'] = '/home/xiaoyu/Desktop/attribute_classify_JD_interview/dataset/pa100k/release_data/release_data'
    dataset['image'] = []
    dataset['att'] = []
    dataset['att_name'] = []
    dataset['selected_attribute'] = range(26)
    # load ANNOTATION.MAT
    data = loadmat('/home/xiaoyu/Desktop/attribute_classify_JD_interview/dataset/pa100k/annotation.mat')
    for idx in range(26):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--save_dird',
        type=str,
        default='/home/xiaoyu/Desktop/attribute_classify_JD_interview/dataset/pa100k/')
    parser.add_argument(
        '--traintest_split_file',
        type=str,
        default="/home/xiaoyu/Desktop/attribute_classify_JD_interview/dataset/pa100k/pa100k_partition.pkl")
    args = parser.parse_args()
    save_dir = args.save_dird
